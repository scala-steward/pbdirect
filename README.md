...
// instantFormat: PBFormat[Instant] = pbdirect.PBFormat$$anon$1@15843a65
```
...
// instantReader: PBScalarValueReader[Instant] = pbdirect.PBScalarValueReaderImplicits$FunctorReader$$anon$2@846eebf
```
...
// instantWriter: PBScalarValueWriter[Instant] = pbdirect.PBScalarValueWriterImplicits$ContravariantWriter$$anon$2@51c6400
```
